//! Windissect-generated Rust FFI bindings for Windows.Graphics.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "D1AA3B701B0C3E854225B064968842AF";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 2899835705;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 21] = [87, 105, 110, 100, 111, 119, 115, 46, 71, 114, 97, 112, 104, 105, 99, 115, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 2899835705 { return 0; }
